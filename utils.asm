...
#		printString -	Solicita ao usuário uma String e a retorna
#				ao programa que solicitou.
...
# Subprograma:	strlen
# Propósito:	Contar a quantidade de caracteres numa string
# Input:	$a0 - Endereço da string alvo
# Retorno:	$v0 - Quantidade de caracteres na string
# Side effects:	Não se aplicam
.text
strlen:
	addi $sp, $sp, -8		# Alocando 8 bytes na pilha para guardar o endereço de retorno e $s0
	sw   $ra, 0($sp)		# Guardando o endereço de retorno na pilha
	sw   $s0, 4($sp)		# Guardando o valor de $s0 para ficar disponível nesta função
...
# Subprograma:	exit
# Propósito:	Finalizar o programa
# Input:	Não se aplica
# Retorno:	Não se aplica
