...
#
# Pseudo Code:
# FunÃ§Ã£o strcat(destination, source):
#    enquanto o caractere atual em destination nÃ£o for o terminador nulo '\0':
#        avance o ponteiro de destino para o prÃ³ximo caractere
#    enquanto o caractere atual em source nÃ£o for o terminador nulo '\0':
#        copie o caractere atual de source para o caractere atual de destino
#        avance o ponteiro de destino para o prÃ³ximo caractere
#        avance o ponteiro de source para o prÃ³ximo caractere
...
main:
	...
	ori $v0, $zero, 8	# ServiÃ§o 8 em v0 indica leitura de string
	la $a0, str1
	lw $a1, InputSize
	syscall			# Salvando o buffer recebido no serviÃ§o 8 em str1
	...
	la $a0, str2
	lw $a1, InputSize
	syscall			# Salvando o buffer recebido no serviÃ§o 8 em str2
